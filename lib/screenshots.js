...
const { safeGame, getQuery } = require("./util");
...
module.exports = {
  routes: [
    { method: "POST", match: (url) => url === "/api/screenshots", handler: handleSaveScreenshot },
    ...
    { method: "DELETE", match: (url) => url.startsWith("/api/screenshots/"), handler: handleDeleteScreenshot },
  ],
  init,
};
